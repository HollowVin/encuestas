...
<!-- edad.i<-data.frame(as.numeric(datos.i.c$"3.1. Edad"), datos.i.c$`37. ¿Cuál es el ingreso aproximado de la unidad familiar (dólares)?`, datos.i.c$escuela, datos.i.c$ciudad) -->
